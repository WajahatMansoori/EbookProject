...
<div id="page-inner">
    <!-- <div class="row"> -->
        ...
        <!-- <div class="container">  -->
			...
			<h3 class="text-center" style="font-size:45px;font-family:timesnewroman;background-color:black;color:white;font-weight:bold;">Categories List</a></h3><br />
			<br />
			<div align="right" style="margin-bottom:5px;">
			<button type="button" name="add" id="add_Cat" class="btn btn-success btn-xs">Add</button>
			</div>
...
$(document).ready(function(){  
	...
	$('#add_Cat').click(function(){
        ...
        $('#error_category_name').css('font-weight','bold');        
		$('#action').val('insert_cat');
